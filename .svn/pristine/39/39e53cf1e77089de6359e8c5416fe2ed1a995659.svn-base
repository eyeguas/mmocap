...
/*
*/
void CMAESHumanPartTracker::step(guscene::view::ViewSet *VSet)throw(GUException)
{
  _TheViewSet=VSet;
...
*/
/*
void CMAESHumanPartTracker::step2(guscene::view::ViewSet *VSet)throw(GUException)
{
  _TheViewSet=VSet;
...
void CMAESHumanPartTracker::stepPart(double* x, double* xbest, double* best_fitness, unsigned int inibodypart, unsigned int endbodypart, double niterations, double nevals)throw(GUException)
{
    double *xfinal;
    double *const*pop;
