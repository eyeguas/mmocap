...
namespace gummocap{
  ...
  namespace algorithms{
	...
	*/
	...
	void setParams(BodyModel<HumanSkeleton> &sk,guscene::view::ViewSet *VSet, PoseEvaluator* fitness_func, Params  p,vector<bool> *DOFmask, vector<bool> *DOFXYZmask, unsigned int nBodyParts);
