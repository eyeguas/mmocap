...
*
*/
Ramanan::Ramanan ( const  Ramanan&X )
{
...
PoseEvaluator * Ramanan::makeCopy()
{
    return new Ramanan ( *this );
}
/*
*
*
...
*
*/
void Ramanan::setParams ( BodyModel<HumanSkeleton> *body,ViewSet *vs )
{
    _TheViewSet=vs;
    _bodyModel=body;
    _nEvals=0;
    ...
    for ( unsigned int v=1;v<_TheViewSet->size();v++ )
    {
        ...
        {
            cerr<<"Ramanan::setParams images of different sizes not supported yet : "<<__FILE__<<":"<<__LINE__<<endl;
            exit ( 0 );
        }
...
*
*/
double Ramanan::evaluate ( BodyModel<HumanSkeleton> *body,ViewSet *vs )
{
  _nEvals++;
...
/**
*/
int Ramanan::xor_special ( IplImage *im1,IplImage *im2 )
{
...
/**
*/
int Ramanan::xor_special ( IplImage *im1,IplImage *im2,int minX,int minY,int maxX,int maxY )
{
