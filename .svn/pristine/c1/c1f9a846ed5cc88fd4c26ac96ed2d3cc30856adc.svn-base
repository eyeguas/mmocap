...
public:
    ...
    */
    void findFeatures(ViewSet *vs,vector< vector<CvPoint2D32f> > &features)throw(GUException);
    /**find matches of previous image in the passed
     * @param newLocations new locations of the points and (-1,-1) if it was not located
    */
    void findMatches(ViewSet *vs,vector< vector<CvPoint2D32f> >&newLocations)throw(GUException);
