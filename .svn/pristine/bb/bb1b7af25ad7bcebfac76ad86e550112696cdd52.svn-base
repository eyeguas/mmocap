...
/**
  */
void OptFlowPm::findFeatures(ViewSet *vs,vector< vector<CvPoint2D32f> > &features)throw(gu::Exception)
{ 
    double quality = 0.01;
...
/**
 */
void OptFlowPm::findMatches(ViewSet *vs,vector< vector<CvPoint2D32f> >&newLocations )throw(gu::Exception)
{
    if (!_findFeaturesCall) 
      throw gu::Exception("OptFlowPm::findMatches You need to call OptFlowPm::findFeatures");
