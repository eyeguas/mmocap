...
// *
// */
// void XorGrad::setParams(BodyModel<HumanSkeleton> *body,ViewSet *vs,float  dotPThres ) throw(gu::Exception)
// {
//     _TheViewSet=vs;
//     _bodyModel=body;
...
//         if (VE==NULL) throw gu::Exception("XorGrad::setParams input view set is not of ViewExtension type. So gradient information is not available");
//     }
// 
...
//             throw gu::Exception("XorGrad::setParams images of different sizes not supported yet");
//     }
