...
namespace algorithms
{
  ...
  *
  */
  void HPSOHTProblemInstance::setParams(BodyModel<HumanSkeleton> &sk, unsigned int globalN, unsigned int inibodypart, unsigned int endbodypart, guscene::view::ViewSet *VSet, PoseEvaluator* fitness_func, PSO::Params p, vector<bool> *DOFmask, vector<bool> *DOFXYZmask){
    _N=globalN;
    _xbest=new double[globalN];
    _inibodypart=inibodypart;
    _endbodypart=endbodypart;
    PSOHTProblemInstance::setParams(sk,VSet,fitness_func,p,DOFmask,DOFXYZmask);
  }
  /**
 *
 *
