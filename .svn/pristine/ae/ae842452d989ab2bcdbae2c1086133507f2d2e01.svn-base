#ifndef _gummocap_Ramanan_POSEEVALUATORS_
#define _gummocap_Ramanan_POSEEVALUATORS_
...
class Ramanan: public PoseEvaluator
            /**\brief This class represents the Ramanan fitness function.
