...
*/
{
  ...
  public:
    ...
    */
    ...
    //void stepSeq(guscene::view::ViewSet *VSet)throw(GUException);
    //void stepParallel(guscene::view::ViewSet *VSet)throw(GUException);
    //void stepParallelLimbs(guscene::view::ViewSet *VSet)throw(GUException);
    //void stepLimbs(unsigned int first_limb, unsigned int second_limb, tChromosomeReal xlimbs_in, tChromosomeReal xlimbs_out, unsigned int ini_first_limb, unsigned int end_first_limb, unsigned int ini_second_limb, unsigned int end_second_limb, double niterations, double numevals)throw(GUException);
    /**Performs an step of the algorithm in a body part: a CMAES search.
    */
    void stepPart(tChromosomeReal* x, tChromosomeReal* xbest, double* best_fitness, unsigned int inibodypart, unsigned int endbodypart, double niterations, double maxeval)throw(GUException);
