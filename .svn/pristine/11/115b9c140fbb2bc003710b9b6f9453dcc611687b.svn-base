...
*
*/
void MACMAChainsHumanPartTracker::step(guscene::view::ViewSet *VSet)throw(GUException){
  _TheViewSet=VSet;
...
void MACMAChainsHumanPartTracker::stepPart(tChromosomeReal* x, tChromosomeReal* xbest, double* best_fitness, unsigned int inibodypart, unsigned int endbodypart, double niterations, double maxeval)throw(GUException)
{
...
/*
void MACMAChainsHumanPartTracker::stepParallel(guscene::view::ViewSet *VSet)throw(GUException)
{
...
*/
/*
void MACMAChainsHumanPartTracker::stepParallelLimbs(guscene::view::ViewSet *VSet)throw(GUException)
{
