...
namespace gummocap{
  ...
  namespace algorithms{
	...
	*/
	...
	/**
	*/
	HTFitnessFunction(unsigned int N, PoseEvaluator* fitness_function, BodyModel<HumanSkeleton> &sk,guscene::view::ViewSet* TheViewSet,vector<bool> *DOFmask,vector<bool> *DOFXYZmask);
	/**Releases the memory
	*/
	~HTFitnessFunction();
