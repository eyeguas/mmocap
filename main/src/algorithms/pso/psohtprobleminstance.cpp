...
namespace algorithms
{
  ...
  *
  */
  void PSOHTProblemInstance::setParams(BodyModel<HumanSkeleton> &sk,guscene::view::ViewSet *VSet, PoseEvaluator* fitness_func, PSO::Params p, vector<bool> *DOFmask, vector<bool> *DOFXYZmask){
