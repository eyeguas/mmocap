...
namespace algorithms
{
  ...
  *
  */
  void PSOHumanTracker::setParams(BodyModel<HumanSkeleton> &sk,guscene::view::ViewSet *VSet, PoseEvaluator* fitness_func, Params  p, vector<bool> *DOFmask, vector<bool> *DOFXYZmask)
  {
    ...
    _pso_instance=new PSOHTProblemInstance();
    _pso_instance->setParams(_bodyModel,_TheViewSet,_fitness_function, PSO::Params(_params.number_of_agents, _N, _params.maxv, _params.irang, _params.irang, _params.initial_weight, _c_1, _c_2, 0.0, PSO::INFINITE, _params.stop_maxeval, 1), DOFmask, _reducedDOFXYZmask);
  ...
  *
  */
  void PSOHumanTracker::step(guscene::view::ViewSet *VSet)throw(gu::Exception){
