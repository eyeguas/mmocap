...
namespace algorithms
{
     ...
     */
  {
	...
	*/
      ...
      void setParams(BodyModel<HumanSkeleton> &sk,unsigned int globalN,unsigned int inibodypart, unsigned int endbodypart, guscene::view::ViewSet *VSet, PoseEvaluator* fitness_func, PSO::Params p, vector<bool> *DOFmask, vector<bool> *DOFXYZmask);
