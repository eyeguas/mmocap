...
#include <gu/math/gulinearscale.h>
#include <gu/math/gumatrix.h> 
namespace gummocap {
...
public:
    ...
    */
    void setParams(Particle initParticle, vector<double> noise,Parameters  P)throw(gu::Exception);
  ...
  /**Returns the number of parallel threads that will be employed to do calcualtion
    ...
    */
    void setMask(vector<bool> activeElements)throw(gu::Exception);
protected:
