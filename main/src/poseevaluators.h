...
public:
     ...
     */
    virtual vector<float> getViewFitness()throw(gu::Exception){throw gu::Exception(" getViewEvaluations not implemented");}
    /**Set a mask to select these views to be employed
     */
    virtual void setValidViews(vector<bool> vviews)throw(gu::Exception){throw gu::Exception(" PoseEvaluator::getViewEvaluations not implemented");}
};
