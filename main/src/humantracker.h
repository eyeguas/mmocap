...
public:
    ...
    */
    ...
    /**
    */
    virtual void  step ( guscene::view::ViewSet *VSet ) throw ( gu::Exception ) =0;
    /**
     */
    ...
    /**Set a mask to select these views to be employed
      */
    virtual void setValidViews ( vector<bool> vviews ) throw ( gu::Exception ) {throw gu::Exception ( " HumanTracker::setValidViews not implemented for current algoritm" );}
