...
*/
{
  ...
  public:
    ...
    */
    ...
    //void step2(guscene::view::ViewSet *VSet)throw(GUException);
    /**Performs an step of the algorithm in a body part: a CMAES search.
    */
    /**Performs an step of the algorithm in a body part: a CMAES search.
    */
    void stepPart(double* x, double* xbest, double* best_fitness, unsigned int inibodypart, unsigned int endbodypart, double niterations, double maxevals)throw(GUException);
